...
satpam.login(token="EnTVEw78vGuh3X6NbW04.zP524czlanxAUxQq9KG6Xa.GInyB+mPWnzzLgNFSse6zUp3P62tWQu1cMd/fU+PU+M=")
satpam.loginResult()

cl = LINETCR.LINE() #Luffy
cl.login(token="EnFWhiIEs7bLGQJOfl3a.sKQaHPCoAbv9Whh0f8P9kG.ZNlxb0CF2IKxzWeo7yEiFul1bPoj1Uq2wsY71soPJ7I=")
cl.loginResult()

ki = LINETCR.LINE() #Zorro
ki.login(token="EnZKPVqPzuMLKn2YZANb.r8W6TxPksnlJy1tTEaUGgW.l4z8fq2Denk0rXBOqy1e5rCz2Dm2ucY+SXqFBKRN/+4=")
ki.loginResult()

kk = LINETCR.LINE() #Sanji
kk.login(token="EnGtXbSFISEs8JLhUTf5.SO84MBF1S6Wagq3ANsJqvq.5Gd7ymQX6eMAsg4ClvaaCcEf+Ut6nthGbj+p6F6J9e8=")
kk.loginResult()

kc = LINETCR.LINE() #Ussop
kc.login(token="EnxbFuAmKDE8MuAbXmZ3.qUUXji0suOMgweDVPgs3KW.ndp83VV4rwkUWgIra3y5dgC/h1hLOYW0dgjsSeLc/TA=")
kc.loginResult()

ks = LINETCR.LINE() #Chooper
ks.login(token="En38kRUqRGvw5B9LbuX6.4UPI1E2PKwaefcGAL20xTG.zH+Iq7cPIVYqKzFYaKC1wR6LlpP6xiYpnCGhvH3kUjs=")
ks.loginResult()

ka = LINETCR.LINE() #Franky
ka.login(token="EnUYhEYGywIOFwtBYEOd.JV3uNm1KlsKCw3Xa9YZC7q.ECjUwaT3Th2lte69hwMxFM1VPEsOBBONPALkZjRzWSQ=")
ka.loginResult()

kb = LINETCR.LINE() #Brook
kb.login(token="En1yWdn4fNeT2nADEJ3e.q1bDsdvDxYl87hFsSZAqpG.0l+019MD2neXHxPHjUcSgr6Etq0+ZnYS3AJ5nniIbws=")
kb.loginResult()

ko = LINETCR.LINE() #Nami
ko.login(token="EnqGX41pcfao3CIcluh1.cvu2JhbwWjuPgiq5xpl6Oq.UK47srKlaacYDNkbaau7Uwf4LKDHb76IgW4hUpaAkSM=")
ko.loginResult()

ke = LINETCR.LINE() #Robin
ke.login(token="Enf3kV0UQPf7NezRiXa4.bpXy+AdBttXaFAqpEfOmfa.bcLdoXtl+vtupqm5a5XUtuPU4NHwHgjZ8ZHJ0JtJbDk=")
ke.loginResult()

ku = LINETCR.LINE() # Jinbei
ku.login(token="EntQd6XXfaMYfKeN5646.vdhEhj1SvEhYE4N4wOdjnG.zPA0WptOVy+w++udtuDg+iRqadZNRoXiJjcPYYCF6DY=")
ku.loginResult()
...
k1.login(token="EnV1re2SeADp5UHZoV59.rHBPdIISxrATZH3FLvSHgq.536yFVY2WqYdVjGfZoccFPuqEqzwEy7OWNkD+Y04XnE=")
k1.loginResult()
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Smid,mid1,"u669e76e0264b00d5dab97a90f6483ac4"]
admin=["u669e76e0264b00d5dab97a90f6483ac4"] 
owner=["u669e76e0264b00d5dab97a90f6483ac4"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#--------------------------------
    ...
    #-----------------=Selesai=------------------
              ...
              if msg.from_ in admin:
                ...
                ##cl.sendMessage(msg)
            elif msg.text in ["Qr on","Open qr"]:
              if msg.from_ in admin:
                if msg.toType == 2:
            ...
            elif msg.text in ["Qr off","Close qr"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    X = random.choice(KAC).getGroup(msg.to)
                    X.preventJoinByTicket = True
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Ketik Mek dulu Boss\nBaru Ketik Cek\nok boss ♪")
#-----------------------------------------------

#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Masuk beb","One piece","Join kuy"]:
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye dragon","Kabur all","Kaboor all"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    random.choice(KAC).sendText(msg.to,"Succes Boss")
                                except:
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"™D®∆G0¶™1 hadir")
                ki.sendText(msg.to,"™D®∆G0¶™2 hadir")
                kk.sendText(msg.to,"™D®∆G0¶™3 hadir")
                kc.sendText(msg.to,"™D®∆G0¶™4 hadir")
                ks.sendText(msg.to,"™D®∆G0¶™5 hadir")
                ka.sendText(msg.to,"™D®∆G0¶™6 hadir")
                kb.sendText(msg.to,"™D®∆G0¶™7 hadir")
                ko.sendText(msg.to,"™D®∆G0¶™8 hadir")
                ke.sendText(msg.to,"™D®∆G0¶™9 hadir")
                ku.sendText(msg.to,"™D®∆G0¶™10 hadir")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              msg.contentType = 13
              msg.contentMetadata = {'mid': 'u669e76e0264b00d5dab97a90f6483ac4'}
              cl.sendText(msg.to,"======================")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
    ...
    for zx in range(0,20):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          satpam.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐┅═ই❂͡★kays™┅═ই❂͡⭐⭐👈\n\n™SMULE  FAMILY™")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like by ^™D®∆G0¶™ Bot^\nStatus Boss udah Kami Like\nOwner Kami :\n┅═ই❂͡★kays™┅═ই❂͡")
                    print "Like"
                except:
                    pass
            else:
