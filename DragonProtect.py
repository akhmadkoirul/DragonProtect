                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "||Di Read Oleh||%s\n||By : ™D®∆G0¶™ BOT||\n\n👉ini dia yang ngintip👈\n%s-=CCTV=-\n•nah loo\n•jangan ngintip\n•ketahuan kan\n•ayoo keluar\n\ngak mau keluar tak cipok\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
...
#-----------------------------------------------
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye drag","Kabur all","Kaboor all"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    random.choice(KAC).sendText(msg.to,"T.I👉tentara IBlIEZ")
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': mid}
                    random.choice(KAC).sendMessage(msg)
                    targets = []
                        ...
                        for target in targets:
                          if target not in admin and Bots:
                            try:
                                ...
                                random.choice(KAC).sendText(msg.to,"No Baper kalo T.I datang")
...
#---------------------
        ...
        if op.type == 15:
           if op.param2 in Bots:
              return
           random.choice(KAC).sendText(op.param1, "Bye hati hati ya :v ")
    ...
    for zx in range(0,20):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          satpam.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐™D®∆G0¶™⭐⭐👈\n\n™SMULE FAMILY™")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like by 👉™D®∆G0¶™👈\nStatus Boss udah Kami Like\nOwner Kami :\n┅═ই❂͡★kays™┅═ই❂͡")
                    print "Like"
                except:
                    pass
            else:
